...
class Documentation
{
    ...
    {
        return $this->cache->remember('docs.'.$version.'.index', config('cache.default_duration'), function () use ($version) {
    ...
    {
        return $this->cache->remember('docs.'.$version.'.'.$page, config('cache.default_duration'), function () use ($version, $page) {
